var products = [
    ...
    {
        "category": "Shoes",
        "categoryImg": "shoes.png",
        "contents": [
            {
                "name": "Two Tone Point Toe Flats",
                "code": "SH001",
                "price": "799",
                "image": "shoes1.png"
            },
            {
                "name": "Wine Red Pointed Toe",
                "code": "SH002",
                "price": "689",
                "image": "shoes2.png"
            },
            {
                "name": "Solid Color Ankle Boots",
                "code": "SH003",
                "price": "899",
                "image": "shoes3.png"
            },
            ...
            {
                "name": "Harness Cutout Open Toe",
                "code": "SH006",
                "price": "719",
                "image": "shoes6.png"
            },
            {
                "name": "Sports White Shoes",
                "code": "SH007",
                "price": "679",
                "image": "shoes7.png"
            },
            {
                "name": "Elegant Ankle Strap Heels",
                "code": "SH008",
                "price": "869",
                "image": "shoes8.png"
            }
    ...
    products.forEach((product, index) => {
        categoriesContainer.innerHTML +=
            `<div onclick="loadProducts('` + index + `')" class="card-icon">
                <div class="icon">
                    <img src="assets/images/products/` + product.categoryImg + `">
                </div>
...
function loadProducts(categoryIndex) {
    ...
    products[categoryIndex].contents.forEach(content => {
        ...
        <img src="assets/images/products/`+ content.image + `" alt="` + content.name + `" class="img-fluid">
